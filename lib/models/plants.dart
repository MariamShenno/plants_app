class Plant {
  ...
  static List<Plant> plantList = [
    Plant(
        ...
        humidity: 34,
        temperature: '23 - 34',
        imageURL: 'assets/images/indoor_image_removebg.png',
        isFavorated: true,
        decription:
    ...
    Plant(
        ...
        humidity: 56,
        temperature: '19 - 22',
        imageURL: 'assets/images/outdoor_image_removebg.png',
        isFavorated: false,
        decription:
        'This plant is one of the best plant. It grows in most of the regions in the world and can survive'
            'even the harshest weather condition.',
    ...
    Plant(
        ...
        humidity: 66,
        temperature: '12 - 16',
        imageURL: 'assets/images/living_image_removebg.png',
        isFavorated: true,
        decription:
        'This plant is one of the best plant. It grows in most of the regions in the world and can survive'
            'even the harshest weather condition.',
    ...
    Plant(
        ...
        humidity: 46,
        temperature: '23 - 26',
        imageURL: 'assets/images/garden_image_removebg.png',
        isFavorated: false,
        decription:
        'This plant is one of the best plant. It grows in most of the regions in the world and can survive'
            'even the harshest weather condition.',
